...
public class charEditor extends FieldEditor
{
  ...
  { return "<input name=\""+getInputName()+"\" type=\""+getInputType(formatParams)+"\" value=\"\" "+getParams(formatParams)+" >"; }

  public String formatNotNull(Object o, Dictionary formatParams) 
  { return "<input name=\""+getInputName()+"\" type=\""+getInputType(formatParams)+"\" value=\""+getLiteral(o, formatParams)+"\" "+getParams(formatParams)+" >"; }
