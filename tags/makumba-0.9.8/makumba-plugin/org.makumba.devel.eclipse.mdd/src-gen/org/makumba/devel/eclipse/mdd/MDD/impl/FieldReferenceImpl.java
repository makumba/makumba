 ...
 * <ul>
 *   <li>{@link org.makumba.devel.eclipse.mdd.MDD.impl.FieldReferenceImpl#getField <em>Field</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FieldReferenceImpl extends MinimalEObjectImpl.Container implements FieldReference
{
  ...
  {
    return MDDPackage.Literals.FIELD_REFERENCE;
  }
    ...
    if (field != null && field.eIsProxy())
    {
      ...
      if (field != oldField)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, MDDPackage.FIELD_REFERENCE__FIELD, oldField, field));
      }
    }
    return field;
  }
  ...
  public void setField(FieldDeclaration newField)
  {
    ...
    field = newField;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MDDPackage.FIELD_REFERENCE__FIELD, oldField, field));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MDDPackage.FIELD_REFERENCE__FIELD:
