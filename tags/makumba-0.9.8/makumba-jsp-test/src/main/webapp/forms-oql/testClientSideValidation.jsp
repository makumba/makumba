...
<mak:newForm type="test.Person" action="somethingNonExisting.jsp" name="person" clientSideValidation="live" annotation="after" reloadFormOnError="true" method="post">  
