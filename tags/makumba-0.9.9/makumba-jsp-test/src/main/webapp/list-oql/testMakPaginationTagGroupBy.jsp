...
<mak:list from="test.Language l" offset="$offset" limit="$limit" defaultLimit="$defaultLimit" groupBy="l">
...
<mak:list from="test.Language l" offset="$offset" limit="$limit" defaultLimit="$defaultLimit" id="pagination1" groupBy="l">
  <c:if test="${mak:count()==1}"> <mak:pagination/> </c:if>
  name:<mak:value expr="l.name"/><br>
  isoCode:<mak:value expr="l.isoCode"/><br><br>
  <c:if test="${mak:count()==mak:maxCount()}"> <mak:pagination/> </c:if>
...
<mak:list from="test.Language l" offset="$offset" limit="$limit" defaultLimit="$defaultLimit" id="pagination3" groupBy="l">
  <c:if test="${mak:count()==1}"> <mak:pagination/> </c:if>
  name:<mak:value expr="l.name"/><br>
  isoCode:<mak:value expr="l.isoCode"/><br><br>
  <c:if test="${mak:count()==mak:maxCount()}"> <mak:pagination/> </c:if>
