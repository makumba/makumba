...
<html>
<head><title>Testing mak:nextCount() after multiple nested lists</title></head>
<body>
...
<mak:list from="test.Person p">
  ...
  <mak:list from="test.Language l">
    ...
    &nbsp; &nbsp; &nbsp; &nbsp; <b>Individual</b> list will have ${mak:nextCount()} items<br/>
...
<b>Persons 2</b> list will have ${mak:nextCount()} items<br/>
<mak:list from="test.Person p" id="persons2">
  &nbsp; # countPerson: ${mak:count()}/${mak:maxCount()}<br/>
</mak:list>
<b>Persons 2</b> list had ${mak:lastCount()} items<br/>
