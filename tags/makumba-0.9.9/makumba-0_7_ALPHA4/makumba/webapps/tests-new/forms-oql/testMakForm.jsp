...
testMakFormStart!<form:form action="testMakAddForm.jsp" method="post" clientSideValidation="false">!endMakFormStart
    ...
    testPtrInput!<form:input name="brother" dataType="ptr test.Person"/>!endPtrInput
	<input type="submit">
testMakFormEnd!</form:form>!endMakFormEnd


<mak:object from="test.Person p" where="p.indiv.name='john'">
    testMakFormValueStart!<form:form action="testMakAddForm.jsp" method="post" clientSideValidation="false">!endMakFormValueStart
        ...
        testPtrInputValue!<form:input name="brotherValue" value="p.brother" dataType="ptr test.Person"/>!endPtrInputValue
