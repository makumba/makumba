...
public class AnalysisTree {
    ...
    public void checkOperandTypes() throws antlr.RecognitionException {
        checkOperandTypes(left.makumbaType, right.makumbaType);
    }

    // assumes symetric operations
    public void checkOperandTypes(Object t1, Object t2) throws antlr.RecognitionException {
