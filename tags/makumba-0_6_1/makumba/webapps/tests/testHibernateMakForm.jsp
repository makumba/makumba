...
testMakFormStart!<mak:form action="testHibernateMakAddForm.jsp" method="post">!endMakFormStart
...
<mak:object from="test.Person p" where="p.indiv.name='john'">
    testMakFormValueStart!<mak:form action="testHibernateMakAddForm.jsp" method="post">!endMakFormValueStart
