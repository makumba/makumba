...
/**
 * @author Bart TODO In sql.qed.redirectManager.properties, date = dateSQL --> needs to be implemented??
 */
    ...
    protected boolean unmodified(String fieldName, int type, int size,
        ...
        switch (getFieldDefinition(fieldName).getIntegerType()) {
            ...
            case FieldDefinition._text:
                ...
                return super.unmodified(fieldName, type, size, columns, index) || type == java.sql.Types.BLOB;
