 ...
 * <ul>
 *   <li>{@link org.makumba.devel.eclipse.mdd.MDD.impl.QuantifiedExpressionImpl#getS <em>S</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class QuantifiedExpressionImpl extends UnaryExpressionImpl implements QuantifiedExpression
{
  ...
  public NotificationChain basicSetS(UnionRule newS, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MDDPackage.QUANTIFIED_EXPRESSION__S, oldS, newS);
  ...
  public void setS(UnionRule newS)
  {
    if (newS != s)
    {
      ...
      if (s != null)
        msgs = ((InternalEObject)s).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MDDPackage.QUANTIFIED_EXPRESSION__S, null, msgs);
      if (newS != null)
        msgs = ((InternalEObject)newS).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MDDPackage.QUANTIFIED_EXPRESSION__S, null, msgs);
      msgs = basicSetS(newS, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MDDPackage.QUANTIFIED_EXPRESSION__S, newS, newS));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MDDPackage.QUANTIFIED_EXPRESSION__S:
