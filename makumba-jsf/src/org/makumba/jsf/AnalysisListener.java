...
/**
 * When the root of a view becomes available, this listener will determine the moment when all its children are in
 * place, and invoke the analysis on all mak:list root tags. To install the listener on a context, call
 * {@link #install(FacesContext)}. The context is expected to have a root by that time.
 * 
 * @author cristi
 */
