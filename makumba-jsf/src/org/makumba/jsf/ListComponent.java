...
// @FacesComponent(value = "makumbaList") - does not seem to work without CDI or outside of a container
public class ListComponent extends UINamingContainer {

    public static final String COMPONENT_TYPE = "makumba.List";

    public static final String COMPONENT_FAMILY = "makumba";
    ...
    private boolean isNestedInIterator() {
        ...
        while (parent != null) {
            if (parent instanceof UIData || parent instanceof ListComponent) {
                return true;
            }
    ...
    private static final class IndexedEvent extends FacesEvent {
        ...
        public IndexedEvent(ListComponent owner, FacesEvent target, int index) {
            super(owner);
            this.target = target;
            this.index = index;
        }
        ...
        public void processListener(FacesListener listener) {
            ListComponent owner = (ListComponent) this.getComponent();
