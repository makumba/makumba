...
public class UIRepeat1 extends UINamingContainer {

    /*
     * Makumba note: this is patched version of UIRepeat for bug 1393 (also solves bug 1561) according to 
     *  https://javaserverfaces.dev.java.net/nonav/issues/showattachment.cgi/1221/proposedPatch-1393-20100729.diff
     *  
     *  The class cannot be named UIRepeat as it seems that sometimes the class with the same name from the jar takes effect
     */
    ...
    private boolean isNestedInIterator() {
        ...
        while (parent != null) {
            if (parent instanceof UIData || parent instanceof UIRepeat1) {
                return true;
            }
    ...
    public void process(FacesContext faces, PhaseId phase) {
        ...
        try {
            ...
            if (this.getChildCount() > 0) {
                ...
                this.updateIterationStatus(faces, new IterationStatus(true, (i + s > e || rowCount == 1), i, begin,
                        end, step));
    ...
    private static final class IndexedEvent extends FacesEvent {
        ...
        public IndexedEvent(UIRepeat1 owner, FacesEvent target, int index) {
            super(owner);
            this.target = target;
            this.index = index;
        }
        ...
        public void processListener(FacesListener listener) {
            UIRepeat1 owner = (UIRepeat1) this.getComponent();
    ...
    public void broadcast(FacesEvent event) throws AbortProcessingException {
        if (event instanceof IndexedEvent) {
            ...
            try {
                ...
                int e = end != null ? end : rowCount;
                int s = step != null ? step : 1;
                this.updateIterationStatus(ctx, new IterationStatus(idx == b, (idx + s >= e || rowCount == 1), idx,
                        begin, end, step));
                if (this.isIndexAvailable()) {
