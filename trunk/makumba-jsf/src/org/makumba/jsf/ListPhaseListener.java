...
/**
 * A phase listener example. It needs a component listener (see
 * {@link AnalysisListener}) to actually know when analysis can start, but it
 * may be useful for other purposes.
 * 
 * 
 * TODO: Currently this is not in use as it needs a faces-config declaration
 * which we can do without by installing the AnalysisListener some other way.
 * 
 * @author cristi
 */
