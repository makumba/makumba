...
public class INIFile {
     ...
     * 
     * @param pstrPathAndName
     *            The full path and name of the ini file to be used.
     */
    ...
    /**
     * Returns the specified boolean property from the specified section. This method considers the following values as
     * boolean values.
     * <ol>
     ...
     *            the property to be set.
     * @param pblnVal
     *            the boolean value to be persisted
     */
     ...
     *            the property to be set.
     * @param pintVal
     *            the int property to be persisted.
     */
     ...
     *            the property to be set.
     * @param plngVal
     *            the long value to be persisted.
     */
     ...
     *            the property to be set.
     * @param pdblVal
     *            the double value to be persisted.
     */
     ...
     *            the property to be set.
     * @param pdtVal
     *            the date value to be persisted.
     */
     ...
     *            the property to be set.
     * @param ptsVal
     *            the timestamp value to be persisted.
     */
     ...
     *             if the if the given pattern is invalid
     */
    ...
    /**
     * Removed specified property from the specified section. If the specified section or the property does not exist,
     * does nothing.
     * 
     * @param pstrSection
     *            the section name.
     ...
     *----------------------------------------------------------------------------*/
    /**
     * Procedure to read environment variables. Thanx to http://www.rgagnon.com/howto.html for this implementation.
     */
     ...
     * 
     * @param pstrDtFmt
     *            the date time format string to be checked.
     ...
     * 
     * @param the
     *            full path and name of the file to be checked.
     ...
     * 
     * @param pd
     *            Date that need to be converted to String
     * @param pstrFmt
    ...
    /**
     * Converts the given sql timestamp object to a string representation. The format to be used is to be obtained from
     * the configuration file.
     * 
     * @param pobjTS
     *            the sql timestamp object to be converted.
     * @param pblnGMT
     *            If true formats the string using GMT timezone otherwise using local timezone.
     ...
     * 
     * @param pstrArgs
     *            the command line arguments array if any.
     */
    ...
    private class INISection {
        ...
        /**
         * Construct a new section object identified by the name specified in parameter and associated comments.
         * 
         * @param pstrSection
         *            The new sections name.
         * @param pstrComments
         ...
         * 
         * @param pstrProp
         *            The name of the property to be created or modified.
         * @param pstrValue
        ...
        /**
         * Returns a string array containing names of all the properties under this section.
         * 
         * @return the string array of property names.
         */
         ...
         * 
         * @param pstrProp
         *            the property whose underlying value is to be etrieved.
    ...
    public class INIProperty {
        ...
        /**
         * Returns value of this property. If value contains a reference to environment avriable then this reference is
         * replaced by actual value before the value is returned.
         * 
