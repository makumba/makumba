...
/** Makumba adaptation of the original class in org.hibernate.hql.ast.util. 
...
public final class ASTUtil {
    /**
     * Private empty constructor. (or else checkstyle says: 'warning: Utility classes should not have a public or
     * default constructor.')
     * 
     ...
     * 
     * @param fixture
     *            The node against which to testto be checked for children.
     * @param test
     *            The node to be tested as being a child of the parent.
     * @return True if test is contained in the fixtures's direct children; false otherwise.
     */
