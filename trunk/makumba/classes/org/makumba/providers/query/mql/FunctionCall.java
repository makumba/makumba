...
public class FunctionCall {
    ...
    public FunctionCall(QueryFragmentFunction function, Vector<MqlNode> orderedArguments,
            Vector<Node> orderedArgumentsOrigins, DataDefinition parentType, String path, boolean isFunctionArgument,
            boolean isMQLFunction, boolean isActorFunction, boolean isInWhere) {
        super();
    ...
    public String getKey() {
        ...
        return (function == null ? null : function.getName()) + "_" + orderedArguments + "_" + parentType + "_" + path
                + "_" + isFunctionArgument() + "_" + isMQLFunction + "_" + "isActorFunction:" + isActorFunction
                + "####" + actorType + "_" + isInWhere + "_" + id;
    }
    ...
    public String toString() {
        return "FunctionCall [function=" + function + ", orderedArguments=" + orderedArguments + ", parentType="
                + parentType + ", path=" + path + ", isFunctionArgument=" + isFunctionArgument + ", isMQLFunction="
                + isMQLFunction + ", isActorFunction=" + isActorFunction + ", isInWhere=" + isInWhere + "]";
    }
