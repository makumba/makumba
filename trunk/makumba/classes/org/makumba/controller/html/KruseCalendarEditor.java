...
public class KruseCalendarEditor implements CalendarEditorProvider {
    ...
    public StringBuffer formatEditorCode(String inputName, String calendarLinkFormatting) {
        ...
        if (calendarLinkFormatting != null) {
            ...
            sb.append("<a class=\"" + calendarEditorClass + "\" href=\"#\" onClick=\"" + calendarName
                    + ".showCalendar('" + anchorname + "', " + dateString
                    + "); return false;\" title=\"Pick date in calendar\" name=\"" + anchorname + "\" ID=\""
                    + anchorname + "\">" + calendarLinkFormatting + "</a>\n");
            sb.append("<div id=\""
                    + divname
