...
/**
 * Copies one database to the other. Usage: <code>java org.makumba.copy source dest type1 [type2 ...]</code> Copying is
 * logged (see {@link java.util.logging.Logger}, {@link org.makumba.MakumbaSystem#setLoggingRoot(java.lang.String)}) in
 * the <b><code>"db.admin.copy"</code></b> logger, with {@link java.util.logging.Level#INFO} logging level.
 */
public class copy {
