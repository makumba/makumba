...
testMakFormStart!<mak:form action="testMakAddForm.jsp" method="post" clientSideValidation="false">!endMakFormStart
...
<mak:object from="test.Person p" where="p.indiv.name='john'">
    testMakFormValueStart!<mak:form action="testMakAddForm.jsp" method="post" clientSideValidation="false">!endMakFormValueStart
