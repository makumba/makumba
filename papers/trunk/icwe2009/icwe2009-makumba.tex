...
In this paper, we introduce the framework that enabled the development of this system. We compare its design with web-engineering techniques, and provide a case-study and evaluation of its suitability on the above mentioned web application.\\
...
\subsection{Tech Committee, a an Amateur Community of Practice}\label{sec:setting}
