...
\begin{itemize}
 \item Aspect-oriented Programming. Makumba addresses parts of AOP nicely with form validation and MDD-based authorisation.\\
  ...
  \item Model-driven development. Makumba addresses this with the code generator, and more strictly with auto-forms (http://bugs.best.eu.org/cgi-bin/bugzilla/show_bug.cgi?id=781)
