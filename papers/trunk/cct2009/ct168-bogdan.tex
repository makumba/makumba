...
Besides the design of the Makumba framework itself, a web-based tool was devised where potential members can play with existing code, work with new code, and look at each other's code \cite{bogdan08}, and in general have example data and the necessary programming tools already set up. Such 'sandboxes' were found to be important in cooperative design endeavors \cite{trigg00}.
...
\bibitem{bogdan08}
C.~Bogdan.
\newblock Longstanding success without awareness support: lessons from a collaborative programming tool.
\newblock In {\em Proceedings of the International Conference on the Design of Cooperative Systems (COOP 2008)}, Institut d'Etudes Politiques, Aix-en-Provence, 2008.
...
\bibitem{trigg00}
R. H. Trigg.
\newblock From Sandbox to "Fundbox": Weaving participatory design into the fabric of a busy non-profit.
\newblock In {\em Proceedings of the Participatory Design Conference (PDC 2000)}, pages 174--183, Palo Alto, CA, USA, 2000. Computer Professionals for Social Responsibility (CPSR).
